...
local function autostart_apps()
  ...
  awful.spawn.easy_async_with_shell("XSECURELOCK_PASSWORD_PROMPT=kaomoji XSECURELOCK_BLANK_TIMEOUT=5 XSECURELOCK_BLANK_DPMS_STATE=off xss-lock -l -- xsecurelock")
  --- Compositor

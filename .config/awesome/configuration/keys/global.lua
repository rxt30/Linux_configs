...
awful.keyboard.append_global_keybindings({
  ...
  end, { description = "Swap client with the previous client", group = "screen" }),

  awful.key({ modkey }, "Right", function()
    awful.client.swap.byidx(1)
  end, { description = "Swap client with the next client", group = "screen" }),

  awful.key({ modkey }, "h", function()
    awful.client.focus.bydirection("left")
  end, { description = "focus previous by index", group = "screen" }),

  awful.key({ modkey }, "j", function()
    awful.client.focus.bydirection("down")
  end, { description = "focus next by index", group = "screen" }),
  ...
  end, { description = "open default application search launcher", group = "launcher" }),

  awful.key({ altkey }, "p", function()
    awful.spawn(apps.default.display)
  end, { description = "Redetect displays", group = "launcher" }),

  awful.key({ modkey }, "s", function()
    awful.spawn(apps.default.settings)
  end, { description = "open settings-manager", group = "launcher" }),

...
awesome.connect_signal("signal::battery", function(batteryStatus, batteryPercentage, remainingTimeText)
...
battery_pill:connect_signal("mouse::enter", function()
  remaining_time.visible = true
end)

battery_pill:connect_signal("mouse::leave", function()
